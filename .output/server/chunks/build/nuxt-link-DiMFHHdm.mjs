import { v as vueExports, q as useRouter, j as hasProtocol, w as joinURL, x as parseURL$1, y as parseQuery$1, z as nuxtLinkDefaults, A as useRuntimeConfig, B as navigateTo, C as withTrailingSlash, D as withoutTrailingSlash } from './server.mjs';
...
function defineNuxtLink(options) {
  ...
  return vueExports.defineComponent({
    ...
    setup(props, { slots }) {
      ...
      const isAbsoluteUrl = vueExports.computed(() => typeof to.value === "string" && hasProtocol(to.value, { acceptRelative: true }));
      ...
      return () => {
        ...
        return vueExports.h("a", { ref: el, href, rel, target }, (_b = slots.default) == null ? void 0 : _b.call(slots));
      };
    }
  });
}
...
//# sourceMappingURL=nuxt-link-DiMFHHdm.mjs.map
