...
import { u as useHead, s as ssrRenderAttrs_1, v as vueExports, a as ssrInterpolate_1, b as ssrRenderComponent_1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs_1(vueExports.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-357349d0><div class="fixed left-0 right-0 spotlight z-10" data-v-357349d0></div><div class="max-w-520px text-center z-20" data-v-357349d0><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-357349d0>${ssrInterpolate_1(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-357349d0>${ssrInterpolate_1(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-357349d0>`);
...
//# sourceMappingURL=error-404-CAEGVr6Z.mjs.map
